...
export interface components {
  schemas: {
     ...
     */
    SignedPayloadType: 'FIDO' | 'GENERIC';
    ...
    /** If the registered credential is of type `GENERIC`, this is a BinaryString  representing a HMACSHA256 of the challenge + private key of the credential. If  the registered credential is of type BinaryString, this is a  [`FIDOPublicKeyCredentialAssertion` Object](https://w3c.github.io/webauthn/#iface-pkcredential) */
    SignedPayload:
    | components['schemas']['BinaryString']
    | components['schemas']['FIDOPublicKeyCredentialAssertion'];
    ...
    ThirdpartyRequestsVerificationsPostRequest: {
       ...
       */
      consentId: components['schemas']['CorrelationId'];
      signedPayloadType: components['schemas']['SignedPayloadType'];
      signedPayload: components['schemas']['SignedPayload'];
    };
  };
  responses: {
    /** OK */
...
export interface operations {
  ...
  PostThirdpartyRequestsVerifications: {
    ...
    requestBody: {
      content: {
        'application/json': components['schemas']['ThirdpartyRequestsVerificationsPostRequest'];
      };
    };
  };
}
